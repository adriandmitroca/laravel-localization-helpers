...
class LocalizationMissing extends LocalizationAbstract
{
	...
	protected function getOptions()
	{
		return array(
			...
			array( 'new-value' , 'l' , InputOption::VALUE_OPTIONAL , 'Value of new found lemmas (use %LEMMA for the lemma value or translation). Use null to support fallbacks.' , 'TODO: %LEMMA' ) ,
